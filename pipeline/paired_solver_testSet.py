...
def test():
    ...
    # new_root_test_sets = "D:\\DOMI\\University\\Magistrale\\Tesi\\Pipeline_coding\\Test Set\\to_test_lab_new"
    new_root_test_sets = "D:\\DOMI\\University\\Magistrale\\Tesi\\Pipeline_coding\\Test Set\\to_test_Atlas\\images_noArtifact"
    test_sets = os.listdir(root_test_sets)

    for test_set in test_sets:
        # new_root_test_set = f"{os.path.join(new_root_test_sets, test_set)}_new"
        new_root_test_set = f"{os.path.join(new_root_test_sets)}_new"
